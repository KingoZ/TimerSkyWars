...
public class Hologram {
	...
	public Hologram(Location location, String... lines) {
		...
		for (String line : lines) {
			this.lines.put(++index, new HologramLine(this, location.clone().add(0, 0.33 * index, 0), line));
		}
	}
	...
	public void spawn() {
		...
		Bukkit.getConsoleSender().sendMessage("§aSpawnnaddd!!");
		spawned = true;
