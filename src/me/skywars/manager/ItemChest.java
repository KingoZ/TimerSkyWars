...
public class ItemChest {
	...
	public ItemStack getPotion(Potions potion) {
		...
		if (potion.equals(Potions.FIRE_RESISTANCE)) {
			switch (r) {
			case 2:
				stack = new ItemStack(Material.POTION, 1, (short)8195);
				break;
			case 1:
				stack = new ItemStack(Material.POTION, 1, (short)8259);
				break;
			default:
				stack = new ItemStack(Material.POTION, 1, (short)8195);
				break;
	...
	public ItemStack getItem(Items itens) {
		...
		if (itens.equals(Items.CHESTPLATE)) {
			...
			case 4:
				...
				break;
			case 3:
				stack = getItem(itens, Type.CHAINMAIL, 1);
				break;
			case 2:
				stack = getItem(itens, Type.IRON, 1);
				break;
			case 1:
				stack = getItem(itens, Type.LEATHER, 1);
				break;
			default:
				stack = getItem(itens, Type.LEATHER, 1);
				break;
		...
		if (itens.equals(Items.SWORD)) {
			...
			case 3:
				...
				break;
			case 2:
				stack = getItem(itens, Type.STONE, 1);
				break;
			case 1:
				stack = getItem(itens, Type.WOODEN, 1);
				break;
			default:
				stack = getItem(itens, Type.WOODEN, 1);
				break;
		...
		if (itens.equals(Items.BLOCKS)) {
			...
			switch (r) {
			case 2:
				stack = getItem(itens, Type.WOODEN, Main.getGameManager().maxAndMin(32, 16));
				break;
			case 1:
				stack = getItem(itens, Type.COBBLESTONE, Main.getGameManager().maxAndMin(50, 30));
				break;
			default:
				stack = new ItemStack(Material.WOOD, Main.getGameManager().maxAndMin(32, 16));
				break;
			}
		}
		if (itens.equals(Items.FOOD)) {
			...
			switch (r) {
			case 2:
				stack = getItem(itens, Type.COOKED_BEEF, Main.getGameManager().maxAndMin(20, 12));
				break;
			case 1:
				stack = getItem(itens, Type.GOLDEN_APPLE, Main.getGameManager().maxAndMin(6, 4));
				break;
			default:
				stack = getItem(itens, Type.COOKED_BEEF, Main.getGameManager().maxAndMin(20, 12));
				break;
		...
		if (itens.equals(Items.OTHER)) {
			...
			switch (r) {
			case 4:
				stack = new ItemStack(Material.EGG, Main.getGameManager().maxAndMin(20, 12));
				break;
			case 3:
				stack = new ItemStack(Material.SNOW_BALL, Main.getGameManager().maxAndMin(20, 12));
				break;
			case 2:
				stack = new ItemStack(Material.ARROW, Main.getGameManager().maxAndMin(20, 12));
				break;
			case 1:
